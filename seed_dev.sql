...
values
  ('max_evidence_file_size_kb', '1024'::jsonb, 'Dung luong file minh chung toi da mac dinh.', true),
  ('allowed_evidence_file_types', '["jpg", "jpeg", "png", "webp"]'::jsonb, 'File type mac dinh cho evidence. PDF chua bat.', true),
  ('allow_pdf_evidence_default', 'false'::jsonb, 'PDF evidence mac dinh tat.', true),
  ('keep_old_files_default', 'true'::jsonb, 'Mac dinh giu file cu khi gui lai.', false),
...
values (
  ...
  'cuoc-thi-truc-tuyen-mau',
  'Cuoc thi mau dung de kiem tra schema, RLS va approval flow trong moi truong dev/test.',
  'active',
  now() - interval '1 day',
...
set title = excluded.title,
    ...
    allow_pdf_evidence = excluded.allow_pdf_evidence,
